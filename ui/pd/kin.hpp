...
public:
	...
	static bool Load(const std::string &char_file, Eigen::MatrixXd &out_joint_mat);
	...
	static void PoseProcessPose(const Eigen::MatrixXd& joint_mat, Eigen::VectorXd& out_pose);
	...
	static std::string BuildJointJson(const tJointDesc& joint_desc);
